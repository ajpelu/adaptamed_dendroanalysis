...
write_csv(teffect, "data/dendroapadtamed_final_model_teffect.csv")
...
write_csv(peffect, "data/dendroapadtamed_final_model_peffect.csv")
...
```{r}
model_ratio_time <- (surf2005 + surf2010) / 
  (surf2015 + surf2020)

ggsave(
   model_ratio_time,
   file = "output/figure_model_ratio_time.jpg",
   dpi = 600,
   width = 12, height = 12
 )
```
...
surf_hal <- pred_mcombrat7 |> 
  ...
  metR::geom_contour_fill(aes(z = ratio_pred, 
                          ...
                          colour = "white", clip = bb) + 
  geom_point(
    data = (d |> dplyr::filter(sp_code == "halepensis")),
    colour = "black", alpha = 0.4, 
    size = 1.7
  ) + 
  metR::geom_label_contour(aes(z = ratio_pred),
...
surf_pin <- pred_mcombrat7 |> 
  ...
  metR::geom_contour_fill(aes(z = ratio_pred, 
                          ...
                          colour = "white", clip = bb) + 
  geom_point(
    data = (d |> dplyr::filter(sp_code == "pinaster")),
    colour = "black", alpha = 0.4, 
    size = 1.7
  ) + 
  metR::geom_label_contour(aes(z = ratio_pred),
...
surf_nig <- pred_mcombrat7 |> 
  ...
  metR::geom_contour_fill(aes(z = ratio_pred, 
                          ...
                          colour = "white", clip = bb) + 
  geom_point(
    data = (d |> dplyr::filter(sp_code == "nigra")),
    colour = "black", alpha = 0.4, 
    size = 1.7
  ) + 
  metR::geom_label_contour(aes(z = ratio_pred),
...
surf_syl <- pred_mcombrat7 |> 
  ...
  metR::geom_contour_fill(aes(z = ratio_pred, 
                          ...
                          colour = "white", clip = bb) + 
  geom_point(
    data = (d |> dplyr::filter(sp_code == "sylvestris")),
    colour = "black", alpha = 0.4, 
    size = 1.7
  ) + 
  metR::geom_label_contour(aes(z = ratio_pred),
...
```{r}
model_ratio_sp <- (surf_hal + surf_pin) / 
  (surf_nig + surf_syl)

ggsave(
   model_ratio_sp,
   file = "output/figure_model_ratio_sp.jpg",
   dpi = 600,
   width = 12, height = 12
 )
```
